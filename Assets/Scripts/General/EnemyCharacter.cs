...
public class EnemyCharacter : MonoBehaviour
{
    ...
    /// 血量更新
    /// </summary>
    public UnityEvent<EnemyCharacter> OnHealthChange;
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        if(collision.CompareTag(Tags.WATER))
        {
            ...
            EventHandler.CallEnemyHealthUIBarChangeEventNew(this, enemy,enemy.curHealthBar);
    ...
    public void TakeDamage(Attack attacker)
    {
        ...
        if (currentHealth - attacker.damage > 0)
        {
            ...
            EventHandler.CallEnemyGetHurtEvent(attacker.transform);
        ...
        else
        {
            ...
            // 执行死亡事件  死亡动画、游戏结束等等
            //OnDead?.Invoke();
            EventHandler.CallEnemyDeadEvent();
        }
        //OnHealthChange?.Invoke(this);
